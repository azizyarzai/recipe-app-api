...
class PublicUserApiTests(TestCase):
    ...
    def test_password_too_short(self):
        """Test that must be more than 5 characters"""
        payload = {
            "email": "test@gmail.com",
            "password": "pw"
        }
    ...
    def test_create_token_invalid_credentials(self):
        """Test that token is not created if invlid credentials are given"""
...
class PrivateUserApiTests(TestCase):
    ...
    def test_update_user_profile(self):
        """Test updating profile for authenticated in user"""
        payload = {
            "name": "aziz@gmail.com", "password": "password123"
        }
