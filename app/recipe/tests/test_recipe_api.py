...
def sample_recipe(user, **params):
    """Create and return and return a sample recipe"""
    defaul = {
        "title": "Sample Recipe",
        "time_minutes": 10,
        "price": 5.00
    ...
    defaul.update(params)
    return Recipe.objects.create(user=user, **defaul)


class PublucRecipeApiTests(TestCase):
...
class RecipeImageUploadTests(TestCase):
    ...
    def test_upload_image_to_recipe(self):
        ...
        with tempfile.NamedTemporaryFile(suffix=".jpg") as ntf:
            ...
            ntf.seek(0)
            res = self.client.post(url, {"image": ntf}, formate='multipart')
